...
class DocumentReviewServiceTest extends TestCase
{
     ...
     */
    private function reviewFixture(string $slug, bool $activeCandidate = true): array
    {
        ...
        $result = DocumentExtractionResult::create([
            ...
            'normalized_payload' => [
                'fields' => ['document_number' => 'PI-42', 'document_date' => '2026-08-24', 'currency' => 'SAR'],
                'lines' => [['quantity' => '1', 'unit_price_minor' => 10000, 'discount_minor' => 0, 'tax_amount_minor' => 1500, 'total_minor' => 11500]],
            ],
