...
{
    /**
     * إضافة price_list_id بمفتاح أجنبي بعد إصلاح 085 تعيد بناء invoices في
     * SQLite، فتستحضر قيد `(tenant_id, number)` القديم. نعيد بناء الفهارس
     * الصحيحة هنا بعد آخر تغيير بنيوي للجدول؛ PostgreSQL لا يحتاج هذا المسار.
     */
    ...
    {
        // تصحيح بنيوي: لا نعيد قيداً أضيق يرفض أرقام فروع صحيحة.
    }
