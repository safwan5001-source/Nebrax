...
class ZatcaService
{
    ...
    public function buildFor(Invoice $invoice): array
    {
        ...
        // ═══════════════════════════════════════════════════════════
        //  عدّاد ZATCA — نطاقه `tenant_id` حصراً، ولا يدخله الفرع أبداً
        // ═══════════════════════════════════════════════════════════
        //  ICV يمثّل سلسلة إصدار الفاتورة الإلكترونية **للكيان القانوني
        //  الواحد**. فبينما صار ترقيم المستندات مستقلاً لكل فرع، يبقى هذا
        //  العدّاد موحَّداً للمستأجر — تقسيمه بالفرع يخالف المواصفة ويكسر
        //  السلسلة عند الهيئة. لذلك لا يمرّ عبر طبقة الترقيم الموحَّدة
        //  (`GeneratesDocumentNumbers`) ولا يُدرج فيها لاحقاً.
        //
        //  قفل صفّ المستأجر يُسلسِل الترحيلات المتزامنة: بدونه يقرأ ترحيلان
        //  العدّادَ نفسه فيُنتجان ICV مكرراً **بصمت** — والقيد الفريد
        //  `(tenant_id, zatca_icv)` هو الحاجز الأخير خلفه.
