...
class DocumentWorkflowService
{
    ...
    private const TRANSITIONS = [
        ...
        'needs_review' => [DocumentWorkflowStatus::READY_FOR_DRAFT, DocumentWorkflowStatus::REVIEWED, DocumentWorkflowStatus::QUEUED, DocumentWorkflowStatus::ARCHIVED, DocumentWorkflowStatus::CANCELLED],
        ...
        'reviewed' => [DocumentWorkflowStatus::NEEDS_REVIEW, DocumentWorkflowStatus::ARCHIVED, DocumentWorkflowStatus::CANCELLED],
