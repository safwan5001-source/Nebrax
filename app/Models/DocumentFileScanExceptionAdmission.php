...
class DocumentFileScanExceptionAdmission extends BaseModel {
 use HasUuids, BranchScoped; public $incrementing=false; protected $keyType='string'; protected $fillable=['document_file_id','document_batch_id','tenant_id','branch_id','platform_document_file_scan_exception_id','admitted_at']; protected function casts():array{return ['admitted_at'=>'immutable_datetime'];}
