...
class UpdateFuelStationDeviceRequest extends FormRequest
{
    ...
    {
        return [
            'device_key' => ['sometimes', 'string', 'max:128', 'regex:/^[a-z0-9][a-z0-9._:-]*$/'],
            'name' => ['sometimes', 'string', 'min:2', 'max:160'],
            'device_type' => ['sometimes', 'string', Rule::in([
            ...
            'adapter_key' => ['sometimes', 'string', 'max:64', 'regex:/^[a-z0-9][a-z0-9._:-]*$/'],
