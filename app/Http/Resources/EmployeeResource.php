...
class EmployeeResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'basic_salary'       => Money::toRiyal($contract?->basicSalary() ?? 0),
            'allowances'         => Money::toRiyal(($contract?->gross() ?? 0) - ($contract?->basicSalary() ?? 0)),
            'gosi'               => Money::toRiyal($contract?->gosiTotal() ?? 0),
            'other_deductions'   => Money::toRiyal($contract?->otherDeductionsTotal() ?? 0),
