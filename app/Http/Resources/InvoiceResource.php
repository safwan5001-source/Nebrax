...
class InvoiceResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'print_template_override_revision_id' => $this->print_template_override_revision_id,
            'print_template_override_revision' => $this->whenLoaded('printTemplateOverrideRevision', fn () => [
                'id' => $this->printTemplateOverrideRevision->id,
                'version' => $this->printTemplateOverrideRevision->version,
                'definition' => $this->printTemplateOverrideRevision->definition,
                'document_types' => $this->printTemplateOverrideRevision->document_types,
            ]),
            'pdf_template_override_revision_id' => $this->pdf_template_override_revision_id,
            'pdf_template_override_revision' => $this->whenLoaded('pdfTemplateOverrideRevision', fn () => [
                'id' => $this->pdfTemplateOverrideRevision->id,
                'version' => $this->pdfTemplateOverrideRevision->version,
