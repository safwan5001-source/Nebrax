...
class FuelSaleResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'corporate_fuel_contract_price_id' => $this->corporate_fuel_contract_price_id,
            'corporate_price_source' => $this->corporate_price_source,
            'contract_payment_terms_days' => $this->contract_payment_terms_days === null ? null : (int) $this->contract_payment_terms_days,
            ...
            'invoice_due_date' => $this->whenLoaded('invoice', fn () => $this->invoice?->due_date?->toDateString()),
