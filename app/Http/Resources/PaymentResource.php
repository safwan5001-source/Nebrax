...
class PaymentResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'fee_amount'   => Money::toRiyal($this->fee_amount),
            'fee_tax_amount' => Money::toRiyal($this->fee_tax_amount),
            'fee_expense_account_id' => $this->fee_expense_account_id,
            'fee_expense_account_name' => $this->whenLoaded('feeExpenseAccount', fn () => $this->feeExpenseAccount?->name),
            'notes'        => $this->notes,
