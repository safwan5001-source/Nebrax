...
class ProductController extends ApiController
{
    ...
    /**
     * ═════════════════════════════════════════════════════════════════
     *  الباركودات البديلة المُدخلة مع نموذج الإنشاء (create)
     * ═════════════════════════════════════════════════════════════════
     *  الـ API لا يمتلك «حالة انتظار» — الـ ProductDialog يُنشئ المنتج أولاً
     *  ثم تُضاف الباركودات البديلة عبر مسارات منفصلة. لكن نموذج الإنشاء
     *  يسمح بإضافة الباركود قبل الحفظ، فتمرّرها دفعةً واحدة عند الإنشاء.
     *
    ...
    /**
     * ═════════════════════════════════════════════════════════════════
     *  إنشاء باركود بديل واحد — مستخدم من مساري الإنشاء والتعديل معاً
     * ═════════════════════════════════════════════════════════════════
    ...
    /**
     * ═════════════════════════════════════════════════════════════════
     *  إنشاء باركود بديل واحد — لمسار التعديل (storeBarcode)
     * ════════════════════════════════════════════════════════════════
