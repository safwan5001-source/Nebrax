...
class PaymentController extends ApiController
{
    ...
    {
        return (new PaymentResource(Payment::with(['allocations.allocatable', 'printTemplateRevision', 'pdfTemplateRevision', 'thermalTemplateRevision'])->findOrFail($id)))->response();
    }
    ...
    public function post(string $id): JsonResponse
    {
        ...
        return (new PaymentResource($posted->load(['printTemplateRevision', 'pdfTemplateRevision', 'thermalTemplateRevision'])))->response();
    }
}
