...
class SalesConfigController extends ApiController
{
    ...
    private const DEFAULTS = [
        ...
        'pos'        => ['default_customer_id' => null, 'default_customer' => PosSettings::DEFAULT_WALKIN_CUSTOMER, 'print_receipt' => true, 'receipt_paper_size' => PosSettings::RECEIPT_PAPER_THERMAL_80, 'allow_discount' => true, 'receipt_footer' => '', 'enabled_payment_method_ids' => [], 'payment_methods_mode' => PosSettings::PAYMENT_METHODS_ALL_ACTIVE, 'default_payment_method_id' => null, 'apply_customer_price_list' => true, 'allow_unit_price_override' => false, 'show_onscreen_numeric_keypad' => false, 'interaction_mode' => PosSettings::INTERACTION_MODE_AUTO, 'allow_deferred_payment' => true, 'product_category_visibility_mode' => PosSettings::PRODUCT_CATEGORY_VISIBILITY_ALL, 'product_category_ids' => [], 'cash_refund_policy' => PosSettings::CASH_REFUND_ORIGINAL_CASH_ONLY, 'exchange_surplus_policy' => PosSettings::EXCHANGE_SURPLUS_CUSTOMER_CREDIT_ONLY, 'held_sale_close_policy' => PosSettings::HELD_SALE_DISCARD_ON_SESSION_CLOSE, 'show_product_images' => true, 'show_cost_profit_in_pos' => false, 'category_presentation_mode' => PosSettings::CATEGORY_PRESENTATION_IMAGE, 'cash_drawer_enabled' => false, 'cash_drawer_driver' => PosSettings::CASH_DRAWER_DRIVER_UNAVAILABLE, 'cash_drawer_auto_open_after_cash' => false, 'blind_cash_count_enabled' => false, 'audit_operation_policies' => ['item_remove' => PosSettings::AUDIT_POLICY_ALLOWED, 'price_override' => PosSettings::AUDIT_POLICY_ALLOWED, 'discount_change' => PosSettings::AUDIT_POLICY_ALLOWED, 'cart_cancel' => PosSettings::AUDIT_POLICY_ALLOWED, 'cash_recount' => PosSettings::AUDIT_POLICY_APPROVAL_REQUIRED], 'sound_enabled' => true, 'scan_sound_enabled' => true, 'error_sound_enabled' => true, 'payment_sound_enabled' => true, 'sound_volume' => 60, 'haptics_enabled' => true],
    ...
    public function update(Request $request, string $section): JsonResponse
    {
        ...
        if ($section === 'pos') {
            ...
            $request->validate([
                ...
                'data.interaction_mode' => ['nullable', 'string', Rule::in(PosSettings::INTERACTION_MODES)],
                'data.allow_deferred_payment' => ['nullable', 'boolean'],
                'data.show_product_images' => ['nullable', 'boolean'],
                'data.show_cost_profit_in_pos' => ['nullable', 'boolean'],
                'data.category_presentation_mode' => ['nullable', Rule::in(PosSettings::CATEGORY_PRESENTATION_MODES)],
