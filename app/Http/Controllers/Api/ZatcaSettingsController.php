 ...
 *
 * مفتاحان اليوم: نطاق عدّاد ICV وسياسة الإرسال (يدوي/تلقائي). ويقرأ
 * `ZatcaService` نطاق ICV فعلاً عند كل ترحيل، بينما سياسة الإرسال عقدٌ محفوظ
 * لطبقة orchestration القادمة ولا تبدأ اتصالاً خارجياً من هذا المتحكّم.
 *
