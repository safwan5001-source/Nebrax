...
class CreditNoteController extends ApiController
{
    ...
    {
        return (new CreditNoteResource(CreditNote::with(['lines', 'printTemplateRevision', 'pdfTemplateRevision'])->findOrFail($id)))->response();
    }
    ...
    public function post(string $id): JsonResponse
    {
        ...
        return (new CreditNoteResource($posted->load(['lines', 'printTemplateRevision', 'pdfTemplateRevision'])))->response();
    }
}
