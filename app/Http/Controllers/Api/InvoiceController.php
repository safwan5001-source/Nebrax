...
class InvoiceController extends ApiController
{
    ...
    {
        return (new InvoiceResource(Invoice::with(['lines', 'printTemplateRevision'])->findOrFail($id)))->response();
    }
    ...
    public function post(string $id): JsonResponse
    {
        ...
        return (new InvoiceResource($posted->load(['lines', 'printTemplateRevision'])))->response();
    }
