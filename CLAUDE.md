...
**المالية**
- المصروفات **(إصدار تشغيلي أول: تصنيفات، بائع/مورّد، مرفقات، ضريبة، مركز تكلفة، مسودة وترحيل)** · سندات القبض **(إصدار تشغيلي أول: قائمة، مسودة، تخصيص فاتورة، عرض وترحيل)** · خزائن وحسابات بنكية **(إصدار تشغيلي أول: خزينة/بنك مرتبطان بحساب أستاذ، رئيسي، تعطيل وحذف آمن، تحويل داخلي وقيد متوازن، سياسة رصيد سالب قابلة للضبط)** · عُهَد الموظفين **(إصدار أول: مسودة وصرف مرحّل من خزينة/بنك إلى حساب عُهَد الموظفين، عرض/مطبوعات/نسخ وحذف آمن؛ التسويات مؤجلة لأنواع التسوية)** · إعدادات المالية **(إصدار أول: مركز إعدادات، تصنيفات مصروفات، وأنواع تسوية مشتركة للمؤسسة؛ دورة تسوية العُهَد الفعلية مؤجلة)**
