...
- ينتقي سند الدفع طريقة نشطة، ثم يلتقط **الاسم والرسوم وحساب المصروف** في السند قبل الترحيل. تعديل الطريقة لاحقاً لا يعيد تفسير المسودات أو السندات المترحلة.
- `Settings::finance.payment_fee_application` يحدد نطاق الرسوم (`received` أو `paid` أو `both` أو `none`). الافتراض `both` هو سياسة المؤسسة الحالية، وتتحمل المنشأة الرسوم دائماً.
- تُخزّن النسبة كنقاط أساس (`0.70% = 70`) وتُحسب كل الرسوم والضرائب بالهللات؛ لا `float`. عند تفعيل الرسوم، يلزم حساب مصروف فعلي غير تجميعي.
- **قيد القبض مع الرسوم:** مدين البنك/الصندوق بصافي الإيداع، ومدين مصروف رسوم الدفع، ومدين ضريبة المدخلات إن وجدت، ودائن العملاء بإجمالي السند.
- **قيد الصرف مع الرسوم:** مدين الموردين بإجمالي السند، ومدين مصروف رسوم الدفع، ومدين ضريبة المدخلات إن وجدت، ودائن البنك/الصندوق بإجمالي السند والرسوم والضريبة.
