...
- **`invoices.zatca_icv` خارج هذه الطبقة نهائياً:** عدّاد سلسلة إصدار ZATCA للكيان القانوني الواحد،
  نطاقه `tenant_id` حصراً بحكم المواصفة. لا يُدرج فيها مهما بدا متسقاً.
