...
**المالية**
- المصروفات **(إصدار تشغيلي أول: تصنيفات، بائع/مورّد، مرفقات، ضريبة، مركز تكلفة، مسودة وترحيل)** · سندات القبض · خزائن وحسابات بنكية · عُهَد الموظفين · إعدادات المالية **(قريباً)**
