...
export const PREVIEW_PRODUCTS: PreviewProduct[] = [
  {
    ...
    category: { ar: "الإلكترونيات", en: "Electronics" },
  },
  {
    id: "p2",
    name: { ar: "إبريق ترشيح", en: "Pour-over kettle" },
    category: { ar: "المنزل", en: "Home" },
  },
  {
    id: "p3",
    name: { ar: "كريم عناية", en: "Care cream" },
    category: { ar: "العناية", en: "Care" },
  },
  {
    id: "p4",
    name: { ar: "قميص كتان", en: "Linen shirt" },
    category: { ar: "الأزياء", en: "Fashion" },
  },
  {
    id: "p5",
    name: { ar: "دفتر ملاحظات", en: "Notebook" },
    category: { ar: "المكتب", en: "Office" },
  },
  {
    id: "p6",
    name: { ar: "زجاجة ماء", en: "Water bottle" },
    category: { ar: "الرياضة", en: "Sport" },
  },
  {
    id: "p7",
    name: { ar: "مصباح مكتب", en: "Desk lamp" },
    category: { ar: "المكتب", en: "Office" },
  },
  {
    id: "p8",
    name: { ar: "سجادة تمرين", en: "Training mat" },
    category: { ar: "الرياضة", en: "Sport" },
  },
];
