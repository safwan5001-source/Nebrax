...
mkdir -p app/Models/Concerns app/Services app/Services/Accounting app/Services/Pos app/Services/Pos/Hardware app/Services/Reporting app/Services/PrintTemplates app/Support \
