...
| GitHub CI | قيد الانتظار على رأس الفرع بعد تقرير التنفيذ؛ يُحدَّث عند الاكتمال |
...
- **CI-green SHA:** يُسجَّل بعد نجاح GitHub CI 5/5 (توثيق لاحق؛ لا التزام لمجرد مزامنة الهاش داخل الملف).
