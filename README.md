# أَوْج ERP — النواة المالية (التسليم الأول)
...
> `nibras-erp` أعلاه معرّف تقني قديم محفوظ مؤقتًا للتوافق مع تعليمات التشغيل الحالية؛ ليس اسم العلامة المعروض للمستخدم.
