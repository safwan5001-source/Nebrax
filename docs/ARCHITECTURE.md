...
تدير المنصة القوالب كمراجعات منشورة غير قابلة للتعديل، وتعيّنها حسب المؤسسة أو الفرع، ثم تثبّت مراجعة القالب مع الفاتورة عند الترحيل. المرجع التشغيلي والمعماري الكامل: [منصة قوالب الطباعة](./PRINT_TEMPLATE_PLATFORM.md).
