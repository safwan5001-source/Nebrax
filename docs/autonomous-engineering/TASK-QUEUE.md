...
| 7 | COM-MOBILE-SHIPPING-1 | ready | high | COM-MOBILE-ADDRESSES-1 (done); decision resolved, ADR-10 | Configurable shipping zones/rates, no carrier (carrier selection remains a separate future decision) |
...
| 9 | COM-MOBILE-I18N-1 | ready | normal | decision resolved, ADR-12 | Shared Accept-Language locale resolution (ar default, ar/en supported) |
