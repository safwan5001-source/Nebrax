...
LAST_UPDATED: 2026-09-22 (Payments/Shipping/Promo/I18n/Vertical-Slice decisions resolved, ADR-09..13; COM-MOBILE-I18N-1 done, PR #935; COM-MOBILE-SHIPPING-1 done, PR #937)
LAYER_VERSION: V1
STATUS: EXECUTING
...
- Two candidates remain `ready` (owner-resolved, 2026-09-22): `COM-MOBILE-PAYMENTS-1` (ADR-09, COD/Pay-on-Pickup scope only), `COM-MOBILE-VERTICAL-TEST-1` (ADR-13, partial scope only — should now incorporate Shipping into its end-to-end verification per ADR-13's own incremental-extension instruction).
