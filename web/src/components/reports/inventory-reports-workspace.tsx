          ...
          <Card>
            ...
            <CardContent>
              {!doc || doc.rows.length === 0 ? (
                ...
                <>
                  <ReportMobileRows columns={doc.columns} rows={doc.rows} totalRow={doc.totalRow} emptyText={t('empty')} primaryIndex={view === 'value' ? 1 : view === 'warehouses' ? 3 : view === 'movements' ? 2 : 1} />
