...
const REPORT_CATEGORIES: ReportCategoryDefinition[] = [
  ...
  },
  {
    ...
    reports: [
      ...
      { key: 'customerBalances', href: '/reports/customers/balances', icon: WalletCards, status: 'ready' },
      { key: 'customerSales', href: '/reports/customers/sales', icon: BarChart3, status: 'ready' },
      { key: 'customerPayments', href: '/reports/customers/payments', icon: Receipt, status: 'ready' },
      { key: 'customerAppointments', href: '/reports/customers/appointments', icon: CalendarDays, status: 'ready' },
    ],
  },
  {
    slug: 'inventory',
    icon: Boxes,
    reports: [
      { key: 'stockBalances', href: '/reports/inventory/value', icon: Boxes, status: 'ready' },
      { key: 'productMovements', href: '/reports/inventory/movements', icon: ClipboardList, status: 'ready' },
      { key: 'stockCount', href: '/reports/inventory/stocktakes', icon: ClipboardList, status: 'ready' },
      { key: 'inventoryValue', href: '/reports/inventory/value', icon: WalletCards, status: 'ready' },
      { key: 'inventoryOperations', href: '/reports/inventory/operations', icon: BarChart3, status: 'ready' },
      { key: 'warehouseBalances', href: '/reports/inventory/warehouses', icon: Package, status: 'ready' },
