...
const REPORT_CATEGORIES: ReportCategoryDefinition[] = [
  ...
  },
  {
    ...
    reports: [
      ...
      { key: 'accountLedger', icon: BookOpen, status: 'soon' },
      { key: 'cashFlow', icon: WalletCards, status: 'soon' },
      { key: 'journalEntries', icon: ClipboardList, status: 'soon' },
      { key: 'taxReport', icon: Receipt, status: 'soon' },
    ],
  },
  {
    slug: 'customers',
