      ...
      <form onSubmit={submit} className="space-y-5">
        ...
        <section className="space-y-3 border-t border-border pt-4">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="cname-en">{t('company_name')} (English)</Label>
              <Input id="cname-en" dir="ltr" value={form.name_en} onChange={(e) => set('name_en', e.target.value)} />
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-3">
            ...
            <div className="space-y-1.5">
              <Label htmlFor="unified-number">{t('unified_number')}</Label>
              <Input id="unified-number" dir="ltr" value={form.unified_number} onChange={(e) => set('unified_number', e.target.value)} />
            </div>
          </div>
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="space-y-1.5">
        ...
        <section className="space-y-3 border-t border-border pt-4" aria-labelledby="company-contact-heading">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-1.5"><Label htmlFor="company-email">{t('email')}</Label><Input id="company-email" dir="ltr" type="email" value={form.email} onChange={(e) => set('email', e.target.value)} /></div>
            <div className="space-y-1.5"><Label htmlFor="company-website">{t('website')}</Label><Input id="company-website" dir="ltr" value={form.website} onChange={(e) => set('website', e.target.value)} placeholder="https://" /></div>
          </div>
        </section>
