  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        <Button variant="ghost" size="icon" onClick={() => router.push('/pos')} aria-label={ts('back')}>
          ...
          {loading ? (
            ...
            <form onSubmit={submit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="receipt_footer" value={config.receipt_footer} onChange={(event) => patch('receipt_footer', event.target.value)} />
              </div>
