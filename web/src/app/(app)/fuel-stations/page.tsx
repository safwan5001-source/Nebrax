...
export default function FuelStationsWorkspacePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap justify-end gap-2"><Link href="/fuel-stations/sales"><Button>{t('manageSales')}</Button></Link><Link href="/fuel-stations/shifts"><Button variant="outline">{t('manageShifts')}</Button></Link><Link href="/fuel-stations/receiving"><Button variant="outline">{t('manageReceiving')}</Button></Link><Link href="/fuel-stations/master-data"><Button variant="outline">{t('manageMasterData')}</Button></Link></div>
