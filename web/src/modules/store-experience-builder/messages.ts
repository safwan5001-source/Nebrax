...
export const CUSTOMIZER_MESSAGES = {
  ar: {
    ...
    canonicalIdentityHint: "تُدار الهوية القانونية من إعدادات الشركة ولا يمكن تعديلها هنا.",
    ...
    collapseBuilderNavigation: "طي تنقل بناء تجربة المتجر",
    expandBuilderNavigation: "توسيع تنقل بناء تجربة المتجر",
  ...
  en: {
    ...
    canonicalIdentityHint: "Legal identity is managed in company settings and cannot be edited here.",
    ...
    collapseBuilderNavigation: "Collapse Store Builder navigation",
    expandBuilderNavigation: "Expand Store Builder navigation",
