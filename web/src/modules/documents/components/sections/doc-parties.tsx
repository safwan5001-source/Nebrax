...
export function DocParties({ model }: { model: DocumentModel }) {
  ...
  return (
    <div className={cn('grid grid-cols-3 gap-4', style.sectionGap)}>
      ...
      <div className={card}>
        <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-gray-400">{partyLabel}</div>
      ...
      <div className={card}>
        <div className="mb-1.5 text-[10px] font-bold uppercase tracking-wide text-gray-400">{isInvoice ? t('meta') : tPrint('document_data')}</div>
