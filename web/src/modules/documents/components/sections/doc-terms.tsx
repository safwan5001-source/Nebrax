...
export function DocTerms({ model }: { model: DocumentModel }) {
  ...
  const title = style.composition === 'modern_v2' || style.composition === 'erp_v2' || style.composition === 'classic_v2' || style.composition === 'minimal_v2' ? <ModernFieldLabel field="terms" mode={mode} /> : t('terms');
