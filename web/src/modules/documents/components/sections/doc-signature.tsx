  ...
  return (
    ...
    >
      ...
      <div className="mt-1 w-40 border-t border-[color:var(--muted)] pt-1 text-[10px] text-[color:var(--muted)]">
        {style.composition === 'modern_v2' || style.composition === 'erp_v2' || style.composition === 'classic_v2' || style.composition === 'minimal_v2' || style.composition === 'retail_v2' || style.composition === 'quotation_proposal' || style.composition === 'purchase_order_formal' ? <ModernFieldLabel field="signature" mode={mode} /> : t('signature')}
      </div>
    </div>
  );
}
