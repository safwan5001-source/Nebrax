...
export function DocNotes({ model }: { model: DocumentModel }) {
  ...
  const title = style.composition === 'modern_v2' || style.composition === 'erp_v2' || style.composition === 'classic_v2' || style.composition === 'minimal_v2' || style.composition === 'retail_v2' || style.composition === 'quotation_proposal' || style.composition === 'purchase_order_formal' ? <ModernFieldLabel field="notes" mode={mode} /> : t('notes');
