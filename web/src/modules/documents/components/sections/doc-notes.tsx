...
export function DocNotes({ model }: { model: DocumentModel }) {
  ...
  const frame = style.composition === 'erp' || style.composition === 'erp_v2' || style.composition === 'classic_v2'
    ...
    : style.composition === 'modern_v2' || style.composition === 'minimal_v2' || style.composition === 'retail_v2' || style.composition === 'quotation_proposal'
  ...
  const title = style.composition === 'modern_v2' || style.composition === 'erp_v2' || style.composition === 'classic_v2' || style.composition === 'minimal_v2' || style.composition === 'retail_v2' || style.composition === 'quotation_proposal' ? <ModernFieldLabel field="notes" mode={mode} /> : t('notes');
