  ...
  return (
    <div className={cn('border border-gray-200 bg-gray-50 px-3 py-2', style.cardRadius, style.sectionGap)}>
      <span className="text-[10px] font-bold uppercase tracking-wide text-gray-400">
        {style.composition === 'modern_v2' || style.composition === 'erp_v2' || style.composition === 'classic_v2' || style.composition === 'minimal_v2' || style.composition === 'retail_v2' || style.composition === 'quotation_proposal' || style.composition === 'purchase_order_formal' ? <ModernFieldLabel field="amount_words" mode={mode} /> : t('amount_words')}:{' '}
      </span>
