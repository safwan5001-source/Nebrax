 ...
 */
export type TemplateComposition = 'classic' | 'classic_v2' | 'erp' | 'erp_v2' | 'modern' | 'modern_v2' | 'minimal' | 'minimal_v2' | 'retail' | 'retail_v2' | 'quotation_proposal' | 'purchase_order_formal';
